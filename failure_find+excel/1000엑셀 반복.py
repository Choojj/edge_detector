...
#ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ 함수
...
#ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ 엑셀 초기화

path = ["C:/Users/HSWB/Desktop/edge_detector/failure_find+excel/data1/original_01.png", "C:/Users/HSWB/Desktop/edge_detector/failure_find+excel/data1/original_02.png",
        "C:/Users/HSWB/Desktop/edge_detector/failure_find+excel/data1/modified_01.png", "C:/Users/HSWB/Desktop/edge_detector/failure_find+excel/data1/modified_02.png",
        "C:/Users/HSWB/Desktop/edge_detector/failure_find+excel/data1/modified_03.png", "C:/Users/HSWB/Desktop/edge_detector/failure_find+excel/data1/modified_04.png",
        "C:/Users/HSWB/Desktop/edge_detector/failure_find+excel/data1/modified_05.png", "C:/Users/HSWB/Desktop/edge_detector/failure_find+excel/data1/modified_06.png",
        "C:/Users/HSWB/Desktop/edge_detector/failure_find+excel/data1/modified_07.png", "C:/Users/HSWB/Desktop/edge_detector/failure_find+excel/data1/modified_08.png",
        "C:/Users/HSWB/Desktop/edge_detector/failure_find+excel/data1/modified_09.png", "C:/Users/HSWB/Desktop/edge_detector/failure_find+excel/data1/modified_10.png",
        "C:/Users/HSWB/Desktop/edge_detector/failure_find+excel/data1/modified_11.png", "C:/Users/HSWB/Desktop/edge_detector/failure_find+excel/data1/modified_12.png",
        "C:/Users/HSWB/Desktop/edge_detector/failure_find+excel/data1/modified_13.png", "C:/Users/HSWB/Desktop/edge_detector/failure_find+excel/data1/modified_14.png",
...
#ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ 변수 초기화

    path1 = "C:/Users/HSWB/Desktop/edge_detector/failure_find+excel/data1/original_01.png"
    path2 = path[random.randint(0, len(path) - 1)]
    ...
    cv2.imwrite("C:/Users/HSWB/Desktop/edge_detector/failure_find+excel/data1/absdiff.png", absdiff)

#ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ 엑셀반복

    workbook = openpyxl.load_workbook("C:/Users/HSWB/Desktop/edge_detector/failure_find+excel/data1/test.xlsx")

    sheet1 = workbook.active

    if (failure_mode == 0):
        sheet1.cell(2 + (7 * repeat), 2).value = "합"
        sheet1.cell(2 + (7 * repeat), 3).value = "정상"
    else:
        sheet1.cell(2 + (7 * repeat), 2).value = "불"
        if (failure_mode == 1):
            sheet1.cell(2 + (7 * repeat), 3).value = "길이 높이 감소"
            sheet1.cell(2 + (7 * repeat), 4).value = "-" + str(round((min_max_location[0][3] - min_max_location[0][1]) / original_height * 100, 4)) + "%"
        elif (failure_mode == 2):
            sheet1.cell(2 + (7 * repeat), 3).value = "길이 높이 증가"
            sheet1.cell(2 + (7 * repeat), 4).value = "+" + str(round((min_max_location[0][3] - min_max_location[0][1]) / original_height * 100, 4)) + "%"
        elif (failure_mode == 3):
            sheet1.cell(2 + (7 * repeat), 3).value = "길이 폭 감소"
            sheet1.cell(2 + (7 * repeat), 4).value = "-" + str(round((min_max_location[0][2] - min_max_location[0][0]) / original_width * 100, 4)) + "%"
        elif (failure_mode == 4):
            sheet1.cell(2 + (7 * repeat), 3).value = "길이 폭 증가"
            sheet1.cell(2 + (7 * repeat), 4).value = "+" + str(round((min_max_location[0][2] - min_max_location[0][0]) / original_width * 100, 4)) + "%"
        elif (failure_mode == 5):
            sheet1.cell(2 + (7 * repeat), 3).value = "균일 함몰"
            sheet1.cell(2 + (7 * repeat), 4).value = "X"
        elif (failure_mode == 6):
            sheet1.cell(2 + (7 * repeat), 3).value = "균일 돌출"
            sheet1.cell(2 + (7 * repeat), 4).value = "X"
        elif (failure_mode == 7):
            sheet1.cell(2 + (7 * repeat), 3).value = "비균일 함몰"
            sheet1.cell(2 + (7 * repeat), 4).value = "X"
        elif (failure_mode == 8):
            sheet1.cell(2 + (7 * repeat), 3).value = "비균일 돌출"
            sheet1.cell(2 + (7 * repeat), 4).value = "X"
        elif (failure_mode == 9):
            sheet1.cell(2 + (7 * repeat), 3).value = "채움"
            sheet1.cell(2 + (7 * repeat), 4).value = "X"
        elif (failure_mode == 10):
            sheet1.cell(2 + (7 * repeat), 3).value = "구멍"
            sheet1.cell(2 + (7 * repeat), 4).value = "X"

    for i in range(len(vertex_location)):
        for j in range(0, len(vertex_location[i])):
            sheet1.cell(i + 2 + (7 * repeat), j + 5).value = str(vertex_location[i][j][0]) + ", " + str(vertex_location[i][j][1])

    image = openpyxl.drawing.image.Image("C:/Users/HSWB/Desktop/edge_detector/failure_find+excel/data1/absdiff.png")
    sheet1.add_image(image, "A"+ str(2 + 7 * repeat))

    workbook.save("C:/Users/HSWB/Desktop/edge_detector/failure_find+excel/data1/test.xlsx")

#ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ 엑셀 그래프
...
data = openpyxl.chart.Reference(sheet2, min_col = 2, min_row = 1, max_col = 2, max_row = 11)
cats = openpyxl.chart.Reference(sheet2, min_col = 1, min_row = 1, max_row = 11)
