...
path2 = "C:/Users/HSWB/Desktop/edge_detector/data1/modified_11.png" # 파일위치
...
if (failure_mode == 0):
    ...
    print(f"{failure_mode}, 길이 높이 감소")
elif (failure_mode == 2):
    print(f"{failure_mode}, 길이 높이 증가")
elif (failure_mode == 3):
    print(f"{failure_mode}, 길이 폭 감소")
elif (failure_mode == 4):
    print(f"{failure_mode}, 길이 폭 증가")
elif (failure_mode == 5):
